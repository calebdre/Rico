...
def getgitinfo(username='arshbot'):
    get_user_repos(username)
    #print list_of_repos
    get_num_of_github_commits(username)
    get_num_of_stars_and_forks(username)
    #print 'fork_score: '+str(fork_score)+', star_score: '+str(star_score)+', comment_score: '+str(commit_score)
    return {'fork_score': fork_score, 'star_score': star_score, 'comment_score': commit_score}
